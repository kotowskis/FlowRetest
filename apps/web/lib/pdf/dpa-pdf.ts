...
const LABELS = {
  en: {
    ...
    version: 'Version',
    record: 'Record',
    draft: 'Draft: the text was waiting for legal review when it was accepted.',
    draftDetails: 'Draft: the text was waiting for legal review when it was accepted, and the provider details were not filled in.',
  ...
  pl: {
    ...
    version: 'Wersja',
    record: 'Rekord',
    draft: 'Wersja robocza: w chwili akceptacji tekst czekał na przegląd prawny.',
    draftDetails: 'Wersja robocza: w chwili akceptacji tekst czekał na przegląd prawny, a dane Dostawcy nie były uzupełnione.',
...
export function DpaRecordDocument(input: DpaRecordInput): ReactElement {
  ...
  return h(
    ...
    h(
      ...
      p.draft ? text(s.draft, p.complete ? l.draft : l.draftDetails) : null,
