...
writeFileSync(out, [`NEXT_PUBLIC_SUPABASE_URL=${values.API_URL}`, `NEXT_PUBLIC_SUPABASE_ANON_KEY=${values.ANON_KEY}`, `SUPABASE_SERVICE_ROLE_KEY=${values.SERVICE_ROLE_KEY}`, `APP_URL=${appUrl}`, ''].join('\n'));
