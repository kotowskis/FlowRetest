...
| `apps/web` | hosted report viewer (paid layer, in progress): Next.js 16 and Supabase; organizations, workspaces, tokens, `POST /api/runs`, acceptances, email and Slack notifications, GitHub checks |
